  ...
  useEffect(() => {
    const preloadImages = async () => {
      try {
        ...
        heroImage.src = "/public/lovable-uploads/ab25fdf7-5c56-4558-96da-9754bee039be.png";
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        >
          ...
          >
            <div className="relative">
              <OptimizedImage 
                src="/public/lovable-uploads/ab25fdf7-5c56-4558-96da-9754bee039be.png" 
                alt="Pelúcia Stitch" 
                width={400}
                height={400}
        ...
        >
          <div className="relative">
            <OptimizedImage 
              src="/public/lovable-uploads/1c4608df-7348-4fa2-98f9-0c546b5c8895.png" 
